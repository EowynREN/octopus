...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        self.ElectricDeadPreload = SKAction.playSoundFileNamed("laugh.mp3", waitForCompletion: false)
        self.ElectricCreatePreload = SKAction.playSoundFileNamed("electricCreate.wav", waitForCompletion: false)
        self.RocketExplosionPreload = SKAction.playSoundFileNamed("laugh.mp3", waitForCompletion: false)
        ...
        self.ShieldOffPreload = SKAction.playSoundFileNamed("haha.mp3", waitForCompletion: false)
...
//        GameviewcontrollerBridge.soundOffBtn.hidden = true
    ...
    func redCoinAdd() {
        ...
        if bg_flag == 1{
            CoinTexturesArray = [SKTexture(imageNamed: "ruby_red"),SKTexture(imageNamed: "ruby_red"),SKTexture(imageNamed: "ruby_red")]
            
        } else if bg_flag == 2{
            CoinTexturesArray = [SKTexture(imageNamed: "ruby_blue"),SKTexture(imageNamed: "ruby_blue"),SKTexture(imageNamed: "ruby_blue")]
            
        }else{
            CoinTexturesArray = [SKTexture(imageNamed: "ruby_yellow"),SKTexture(imageNamed: "ruby_yellow"),SKTexture(imageNamed: "ruby_yellow")]
        ...
        let movementAmount = arc4random() % UInt32(self.frame.size.height / 2)
        let pipeOffset = CGFloat(movementAmount) - self.frame.size.height / 4
        redCoin.size.width = 32
        redCoin.size.height = 50
...
//        if bg_flag == 1{
//            rocketherotex1 = SKTexture(imageNamed: "p_fish0.png")
//            
//            
//            rocketExptex1 = SKTexture(imageNamed: "p_fish1.png")
//        }else{
//            if stageLabel.text == "Stage 4" || stageLabel.text == "Stage 5"{
//                rocketherotex1 = SKTexture(imageNamed: "p_fish0.png")
//                rocketExptex1 = SKTexture(imageNamed: "p_fish1.png")
//                
//                
...
//        }
        ...
        if fish_random == 0{
            ...
            if bg_flag == 1{
                ...
                rocket.size.height = 120
            }

        }else{
            if bg_flag == 1{
                rocket.size.width = 140
                rocket.size.height = 100
            }else if bg_flag == 2{
                rocket.size.width = 120
                rocket.size.height = 40
        ...
        print(bgTexture)
        if bg_flag == 1{
            //        let a = SKTexture(imageNamed: "bg01.png")
            //        let b = SKTexture(imageNamed: "bg01.png")
            //        if b.isKindOfClass(SKTexture){
            RocketTexturesArray = [SKTexture(imageNamed: "p_fish0")]
            print("HAHAH THIS IS P_FISH")
            
        }
        else if bg_flag == 2{
            RocketTexturesArray = [SKTexture(imageNamed: "RocketExplode0")]
        }else {
            RocketTexturesArray = [SKTexture(imageNamed: "jellyfish0")]
        }
        
        //         else{
        //            print("WOWOW THIS IS FISH")
        //            if stageLabel.text == "Stage 4" || stageLabel.text == "Stage 5"{
        //                RocketTexturesArray = [SKTexture(imageNamed: "p_fish0")]
        //            }else{
        //
